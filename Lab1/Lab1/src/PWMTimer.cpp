...
PWMTimer::PWMTimer(uint8_t mhz, uint8_t ticks_per_second){
    ...
    TIM1->CCR1 = 500 - 1;                           // налаштовуємо зсув відносно основного виходу;
    ...
    TIM1->CCMR1 |= (TIM_CCMR1_OC1M_0 | TIM_CCMR1_OC1M_1);   // Налаштовуємо режим виводу каналу 1 як неінвертований порівняльний режим
